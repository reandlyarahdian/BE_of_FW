...
import { StackingColorsState } from "./schema/StackingColorsState";
...
export class StackingColors extends Room<StackingColorsState> {
  onCreate(options: any) {
    this.setState(new StackingColorsState());
